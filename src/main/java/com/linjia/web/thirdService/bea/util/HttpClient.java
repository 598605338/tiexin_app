    ...
    private static String innerGet(String url) {
        ...
        try {
            ...
            try {
                ...
                logger.info(String.format("http protocol:%s statusCode:%s reasonPhrase:%s", statusLine.getProtocolVersion(), statusLine.getStatusCode(), statusLine.getReasonPhrase()));
