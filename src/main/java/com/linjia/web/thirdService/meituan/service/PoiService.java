...
public interface PoiService {
     ...
     * @return
     */
    JSONObject poiSave(PoiParam poiParam);

    /**
     * 获取所有门店codes
     * @return
     */
    JSONObject poiGetIds();
     ...
     * @return
     */
    List<PoiParam> poiMget(String appPoiCodes);
     ...
     * @return
     */
    JSONObject poiOpen(String appPoiCode);
     ...
     * @return
     */
    JSONObject poiClose(String appPoiCode);
     ...
     * @return
     */
    JSONObject poiOnline(String appPoiCode);
     ...
     * @return
     */
    JSONObject poiOffline(String appPoiCode, String reason);
     ...
     * @return
     */
    JSONObject poiQualifySave(String appPoiCode, PoiQualificationEnum poiQualificationEnum,
     ...
     * @return
     */
    JSONObject poiSendTimeSave(String appPoiCodes, int sendTime);
     ...
     * @return
     */
    JSONObject poiAdditionalSave(String appPoiCode, String appPoiEmail,
     ...
     * @return
     */
    JSONObject poiUpdatePromotionInfo(String appPoiCode, String promotionInfo);

    /**
     * 获取门店品类列表
     * @return
     */
    List<PoiTagParam> poiTagList();
