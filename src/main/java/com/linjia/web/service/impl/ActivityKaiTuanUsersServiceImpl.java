...
public class ActivityKaiTuanUsersServiceImpl extends BaseServiceImpl<ActivityKaiTuanUsers, Long> implements ActivityKaiTuanUsersService {
	...
	@Override
	public List<String> selectOneKaiTuanUserPhoto(Map<String, String> map) {
		return mapper.selectOneKaiTuanUserPhoto(map);
	}

	@Override
	public List<String> selectTeamUsers(Integer kt_id) {
		return mapper.selectTeamUsers(kt_id);
	}
