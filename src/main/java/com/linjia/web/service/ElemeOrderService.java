...
public interface ElemeOrderService {
	 ...
	 * @return
	 */
    boolean insertElemeOrder(String orderId);
	 ...
	 * @return
	 */
    boolean updateElemeOrder(String orderId, String reason, int updType, Integer type);
	 ...
	 * @return
	 */
    boolean updateElemeLocalOrder(OOrder order);
	 ...
	 * @return
	 */
    boolean insertElemeLocalOrder(OOrder order);
	 ...
	 * @return
	 */
    List<String> getNonReachedMessages();
	 ...
	 * @return
	 */
    List<OMessage> getNonReachedOMessages();
	 ...
	 * @return
	 */
    List<OGoodsItem> selectElemeOrderProducts(String orderId);
}
