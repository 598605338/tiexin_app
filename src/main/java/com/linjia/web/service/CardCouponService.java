...
public interface CardCouponService extends BaseService<CardCoupon, Long>{
	 ...
	 * @return
	 */
	List<CardCoupon> selectCanUsedByUserId(UserCardCouponQuery userCardCouponQuery, String mallCode, List<String> pCodeArray,boolean isFullSubtract,boolean isFreeFreight, boolean isPrepare, Integer ifUseCardCoupons, BigDecimal productPrice);
