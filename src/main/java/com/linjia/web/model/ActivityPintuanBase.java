...
public class ActivityPintuanBase {
    ...
    private Integer baseQuantyMul;
    
    private Integer baseQuantyAdd;
	...
	public Integer getBaseQuantyMul() {
		return baseQuantyMul;
	}

	public void setBaseQuantyMul(Integer baseQuantyMul) {
		this.baseQuantyMul = baseQuantyMul;
	}

	public Integer getBaseQuantyAdd() {
		return baseQuantyAdd;
	}

	public void setBaseQuantyAdd(Integer baseQuantyAdd) {
		this.baseQuantyAdd = baseQuantyAdd;
	}
