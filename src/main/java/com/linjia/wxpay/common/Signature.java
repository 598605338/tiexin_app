...
public class Signature {
	 ...
	 * @throws SAXException
	 */
	public static boolean checkIsSignValidFromResponseString(String responseString) throws ParserConfigurationException, IOException,
			SAXException {
	 ...
	 * @return
	 */
	public static String getAESEncrypt(String pwd, String key) {
		...
		if (!Tools.isEmpty(pwd)) {
			...
			try {
				...
				return AES.aesEncrypt(sb.toString(), key);
			} catch (IOException e) {
				e.printStackTrace();
			}
		}
	 ...
	 * AES解密
	 * lixinling 
	 * 2016年11月9日 上午10:51:52
	 * @param pwd 加密后的密码
	 * @param key 加密时的key
	 * @return
	 */
	public static String getAESDecrypt(String pwd, String key) {
		if (!Tools.isEmpty(pwd)) {
			try {
				String decrypted = AES.aesDecrypt(pwd, key);
				StringBuilder sb = new StringBuilder();
