package com.linjia.wxpay.protocol;
...
public class PayReqData {
     ...
     */
    public PayReqData(String authCode,String body,String attach,String outTradeNo,int totalFee,String deviceInfo,String spBillCreateIP,String timeStart,String timeExpire,String goodsTag,String notify_url,String trade_type,String openid){
