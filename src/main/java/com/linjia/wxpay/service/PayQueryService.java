package com.linjia.wxpay.service;

import com.linjia.wxpay.common.Configure;
import com.linjia.wxpay.protocol.PayQueryReqData;
...
public class PayQueryService extends BaseService{
     ...
     * @throws Exception
     */
    public String request(PayQueryReqData scanPayQueryReqData) throws Exception {
